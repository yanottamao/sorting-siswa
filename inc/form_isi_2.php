...
<div class="mb-3">
    ...
    <input type="text" class="form-control <?php echo $tempat_lahirErr ? 'is-invalid' : null ?>" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan tempat lahir" value="<?php echo $value['tempat_lahir'] ?? null; ?>" />
    <div class="invalid-feedback">
...
<div class="mb-3">
    ...
    <input type="number" class="form-control <?php echo $lama_latihErr ? 'is-invalid' : null ?>" id="lama_latih" name="lama_latih" placeholder="Masukkan lama latih" value="<?php echo $value['lama_latih'] ?? null; ?>" />
    <div class="invalid-feedback">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control <?php echo $tahunErr ? 'is-invalid' : null ?>" id="tahun" name="tahun" placeholder="Masukkan tahun angkatan peserta" value="<?php echo $value['tahun'] ?? null; ?>"></input>
    <div class="invalid-feedback">
        <?php echo $tahunErr; ?>
    </div>
</div>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control <?php echo $angkatanErr ? 'is-invalid' : null ?>" id="angkatan" name="angkatan" placeholder="Masukkan angkatan peserta" value="<?php echo $value['angkatan'] ?? null; ?>"></input>
    <div class="invalid-feedback">
        <?php echo $angkatanErr; ?>
    </div>
</div>
<!-- angkatan -->
...
<!-- jenis -->
<div class="mb-3">
    <label for="jenis" class="form-label">Jenis Angkatan</label>
    <select name="jenis" id="jenis" class="form-control <?php echo $jenisErr ? 'is-invalid' : null; ?>" value="<?php echo $value['jenis'] ?? null; ?>">
        <option value="" selected disabled>Pilih jenis angkatan</option>
